...
export default function MyForm3() {
  ...
  // const handelChange = event => setFirstName(event.target.value);
  // const handelChange = event => setLastName(event.target.value);
  // const handelChange = event => setEmail(event.target.value);
